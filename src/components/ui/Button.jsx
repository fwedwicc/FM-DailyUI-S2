...
const baseStyle = 'flex items-center gap-1.5 rounded-lg md:px-3.5 px-3 md:py-2.5 py-2 text-sm font-semibold text-white shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 transition duration-300 ease-in-out cursor-pointer'

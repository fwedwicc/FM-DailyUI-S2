      ...
      <main>
        <section className='relative h-screen flex flex-col justify-center items-center overflow-hidden'>
          ...
          <div className='absolute flex flex-col justify-center'>
            <span className='text-center bg-gradient-to-r from-blue-300 to-indigo-500 bg-clip-text text-transparent md:text-3xl text-2xl font-bold'>Upcoming Challenge</span>
            <p className='text-center'>More creativity incoming :)</p>
          </div>
          {/* Running Cat */}
          <marquee direction="right" className='absolute -bottom-2'>
            <div className='relative px-4 py-2.5 rounded-lg bg-gray-800/20 border border-gray-800 inline-block mb-4'>
              <p className='leading-none'>frederick is on <span className='text-indigo-400'>#{currentChallengeNumber}</span></p>

...
import { MapDesign, NikeStore, Nike, Adidas, Skechers, Puma, Converse, Reebok, UnderArmour, Vans, NewBalance, Fila } from '../assets/day29'
...
const Day29 = () => {
  ...
  return (
    ...
    >
      ...
      <aside className='z-50 h-screen fixed p-3 lg:flex flex-col items-center justify-between hidden w-20 border-r border-gray-800'>
        {/* Start */}
        <div className='flex flex-col items-center gap-1'>
      ...
      {/* Navigation */}
      <nav className='z-40 fixed flex items-center lg:justify-end justify-between w-full p-2'>
        ...
        <div className='flex items-center gap-3 p-3'>
          ...
          <Avatar
            type='profile'
            size='size-9'
            image='https://avatars.githubusercontent.com/u/84965567?v=4'
      ...
      {/* Main Content */}
      <main className='grid lg:grid-cols-3 grid-cols-1 lg:ml-20 ml-0 h-screen'>
        {/* Side Content */}
        <div className='z-50 md:p-4 p-3 space-y-4 lg:order-1 order-2 col-span-1 overflow-auto custom-scrollbar h-full bg-gray-900'>
          {/* Search */}
          ...
          <div className='flex flex-col gap-2'>
            {[
              ...
              { badge: true, image: Vans, name: 'Vans', branch: 'Las Piñas City', address: 'SM Southmall, Alabang-Zapote Road', ratings: 5, open: '10AM', close: '9PM' },
              { badge: false, image: Reebok, name: 'Reebok', branch: 'Pasig City', address: 'Estancia Mall, Capitol Commons', ratings: 4, open: '10AM', close: '9PM' },
              ...
              { badge: false, image: UnderArmour, name: 'Under Armour', branch: 'Taguig City', address: 'BGC High Street, 9th Ave', ratings: 4, open: '11AM', close: '7PM' },
              { badge: true, image: NewBalance, name: 'New Balance', branch: 'Makati City', address: 'Greenbelt 3, Esperanza Street', ratings: 4, open: '10AM', close: '8PM' },
              { badge: false, image: Converse, name: 'Converse', branch: 'Baguio City', address: 'SM Baguio, Luneta Hill', ratings: 3, open: '9AM', close: '7PM' },
              { badge: true, image: Fila, name: 'Fila', branch: 'Iloilo City', address: 'Robinsons Place Iloilo, De Leon St.', ratings: 2, open: '9AM', close: '6PM' },
            ].map((items, index) => (
              <ItemCard
                key={index}
                badge={items.badge}
        ...
        {/* Map */}
        <div className='relative lg:h-screen h-94 lg:order-2 order-1 col-span-2 overflow-hidden'>
          {/* Sample Map */}
          <img src={MapDesign} alt="Map Design" className='absolute w-full h-full object-cover' />
          {/* Nike - Active */}
          <div className='z-30 absolute flex gap-4 md:top-2/6 top-6 md:right-1/4 -right-12 w-full max-w-[25rem]'>
            <Avatar
              type='profile'
          ...
          {[
            ...
            <div className={`flex flex-col gap-1.5 items-center absolute ${item.position}`} key={index}>
              <Avatar
                type='profile'
